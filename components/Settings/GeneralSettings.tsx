...
export const GeneralSettings: React.FC<GeneralSettingsProps> = ({
    ...
    return (
        <div className="space-y-6">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                ...
                <div className={`${cardBaseClass} rounded-2xl p-4 border shadow-sm h-full`}>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                        {/* Dark Mode */}
                        <div className={`flex justify-between items-center p-3 rounded-xl border h-full ${controlBgClass}`}>
                            <div>
                        ...
                        {/* Visual Theme */}
                        <div className={`p-3 rounded-xl border h-full ${controlBgClass}`}>
            ...
            {/* NAVIGATION & WIDGETS */}
            <div className={`${cardBaseClass} rounded-2xl p-4 border shadow-sm`}>
                    ...
                    <div className="space-y-2">
                         {(sidebarConfig.widgetOrder || Object.keys(widgetLabels)).map((widgetKey, index) => (
                            <div 
                                ...
                                className={`flex justify-between items-center py-1.5 px-3 rounded-lg border cursor-move transition-all ${controlBgClass} hover:border-blue-400 dark:hover:border-blue-500 ${draggingWidgetIndex === index ? 'opacity-30' : ''}`}
                            >
                        ...
                        {navConfig.map((item, index) => {
                            ...
                            return (
                                <div 
                                    ...
                                    className={`flex items-center py-1.5 px-3 rounded-lg cursor-move transition-all border ${controlBgClass} hover:border-blue-400 dark:hover:border-blue-500 ${draggingIndex === index ? 'opacity-30' : ''}`}
                                >
