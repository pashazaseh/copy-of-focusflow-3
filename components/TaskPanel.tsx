                        ...
                        {activeTasks.map((task, index) => {
                            return (
                                <div 
                                    ...
                                    className={`group rounded-2xl border transition-all duration-200 ${isCyberpunk ? 'bg-[#0a0a0a] border-[#00f0ff]/20 hover:border-[#00f0ff]/50 hover:shadow-[0_0_15px_rgba(0,240,255,0.1)]' : 'bg-white dark:bg-gray-800 border-gray-200 dark:border-gray-700 hover:border-blue-300 dark:hover:border-blue-600 hover:shadow-md'} ${draggingTaskIndex === index ? 'opacity-50 scale-95' : ''}`}
                                >
                                    <div className="flex items-center p-4">
                                    {/* Drag Handle */}
                                    {sortBy === 'default' && (
                                        <div className={`mr-3 cursor-move opacity-0 group-hover:opacity-100 transition-opacity ${isCyberpunk ? 'text-[#00f0ff]/40' : 'text-gray-300 dark:text-gray-600'}`}>
                                    ...
                                    <div className="relative flex items-center mr-4">
                                        <input 
                                            ...
                                            className={`w-4 h-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 cursor-pointer transition-all ${isCyberpunk ? 'bg-black border-[#00f0ff]/50 checked:bg-[#00f0ff] checked:border-[#00f0ff]' : 'dark:bg-gray-700 dark:border-gray-600'}`}
                                        />
                                    </div>
                                    ...
                                    <button 
                                        ...
                                        className={`w-6 h-6 rounded-full border-2 mr-4 flex items-center justify-center transition-all ${isCyberpunk ? 'border-[#00f0ff] hover:bg-[#00f0ff]/20' : 'border-gray-300 dark:border-gray-600 hover:border-blue-500 hover:bg-blue-50 dark:hover:bg-blue-900/20'}`}
                                    >
                                    </button>
                                    ...
                                    <div className="flex-1 min-w-0">
                                        <div className="flex items-center gap-2 mb-1">
                                            <p className={`text-sm font-medium ${isCyberpunk ? 'text-[#00f0ff]' : 'text-gray-900 dark:text-white'}`}>{task.title}</p>
                                            {task.priority && (
                                        ...
                                        <div className="flex items-center gap-3">
                                            ...
                                            <div className="relative group/proj">
                                                <select
                                                    ...
                                                    className={`text-[10px] pl-2 pr-1 py-0.5 rounded-md cursor-pointer border-none focus:ring-0 max-w-[120px] truncate appearance-none ${isCyberpunk ? 'bg-[#00f0ff]/10 text-[#00f0ff]/80 hover:bg-[#00f0ff]/20' : 'bg-gray-100 dark:bg-gray-700 text-gray-600 dark:text-gray-300 hover:bg-gray-200 dark:hover:bg-gray-600'}`}
                                            ...
                                            {task.dueDate && (
                                                <span className={`text-[10px] flex items-center gap-1 ${
                                                    ...
                                                    : (isCyberpunk ? 'text-[#00f0ff]/60' : 'text-gray-400 dark:text-gray-500')
                                                }`}>
                                    ...
                                    <div className="flex items-center gap-1">
                                        <button onClick={() => toggleTaskExpansion(task.id)} className={`p-2 rounded-lg transition-all ${isCyberpunk ? 'text-[#00f0ff]/40 hover:text-[#00f0ff] hover:bg-[#00f0ff]/10' : 'text-gray-400 hover:text-blue-600 hover:bg-blue-50 dark:hover:bg-blue-900/20'}`}>
                                        ...
                                        <button onClick={() => handleDelete(task.id)} className={`opacity-0 group-hover:opacity-100 p-2 rounded-lg transition-all ${isCyberpunk ? 'text-[#00f0ff]/40 hover:text-red-500 hover:bg-red-500/10' : 'text-gray-400 hover:text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20'}`}>
