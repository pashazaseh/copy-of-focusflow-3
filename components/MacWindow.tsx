...
export const MacWindow: React.FC<MacWindowProps> = ({ children, title, isDarkMode, onToggleTheme, appTheme = 'default', icon, isFullScreen }) => {
  ...
  return (
    <div className={containerClass}>
      {/* Window Title Bar */}
      {isElectron && platform === 'darwin' && isFullScreen ? null : (
        <div 
